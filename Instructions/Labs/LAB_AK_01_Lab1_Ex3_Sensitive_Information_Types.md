...
4. 如果显示 **“什么是数据分类?”** 消息，请选择 **“关闭”**，并从顶部窗格中选择 **“敏感信息类型”**。

5. 选择 **“(+)创建信息类型”** 打开新建敏感信息类型向导。

6. 在 **“选择名称和说明”** 页面上的 **“名称”** 中键入 *“Contoso 员工 ID”*。

7. 在 **“说明”** 字段中键入 *“Contoso 员工 ID 的模式。”*，并选择 **“下一步”**。

8. 在 **“匹配要求”** 页面上，选择 **“(+)添加元素”**。

9. 选择 **“检测内容包含”** 下面的下拉字段，然后选择 **“正则表达式”**。

10. 在输入字段中输入以下内容： *\s[A-Z]{3}[0-9]{6}\s*

11. 在 **“支持元素”** 下选择 **“+ 添加支持元素”**，然后在下拉菜单中选择 **“包含此关键字列表”**。

12. 在 **“关键字列表”** 下方的文本框中输入以下内容：*员工*, *ID*

13. 将 **“字符接近度”** 值减少到 *100* 个字符。

14. 选择 **“下一步”**。

15. 选择 **“完成”** 以完成向导。

16. 在 **“合规性”** 窗口中，选择 **“是”** 以测试创建的敏感类型。
...
16. 依次选择 **“Joni Sherman”** 和 **“保存更改”**。

17. 确认 **“组成员”** 下方是否列出了 **Joni Sherman**，然后选择 **“关闭”**
...
29. 在第一个 **“架构字段名称”** 中输入 *“Name”*，并选择 **“字段可搜索”**。
...
50. 在 **“字符接近度”** 字段中，输入 *“100”*。

51. 选择 **“下一步”**。

52. 在 **“名称”** 字段中，输入 *“Contoso 员工 EDM”*。

53. 在 **“针对管理员的说明”** 字段中，输入 *“针对员工个人信息的基于 EDM 的敏感信息类型。”*。

54. 选择 **“下一步”**，查看设置，然后选择 **“提交”**。

55. 在 **“已创建你的 EDM 敏感信息类型”** 页面上，选择 **“完成”**。

56. 让 Microsoft 365 合规中心在浏览器中保持打开状态。
...
13. 按 Enter，并将以下文本添加到记事本窗口中的第二行：

    Joni Sherman,01.06.1980,1 Main Street,CSO123456

14. 按 Enter，并将以下文本添加到记事本窗口中的第三行：
...
25. 通过在 PowerShell 中运行以下脚本，下载基于 EDM 的分类敏感信息类型的数据库架构定义：
    ...
    备注：如果最后一条命令失败，则可能需要更多时间才能应用 **“EDM_DataUploaders”** 组成员身份。可能需要一个小时才能下载架构文件。
...
4. 选择 **“(+)创建信息类型”** 打开新建敏感信息类型向导。

5. 在 **“选择名称和说明”** 页面上的 **“名称”** 中输入 *“Contoso 疾病清单”*。

6. 在 **“说明”** 字段中输入 *“员工可能患有的疾病清单。”*，然后选择 **“下一步”**。

7. 在 **“匹配要求”** 页面上，选择 **“(+)添加元素”**。

8. 选择 **“检测内容包含”** 下面的下拉字段，然后选择 **“字典(大型关键字)”**。

10. 选择 **“(+)添加字典”** 和 **“新建关键字字典”** 以打开“关键字字典”窗格。

11. 在 **“为关键字字典选择名称”** 下，输入 **“疾病字典”**。

12. 在 **“输入关键字，每个关键字位于单独的行中。”** 下，输入以下关键字，将每个关键字置于单独的行中：
...
14. 在 **“关键字字典”** 下，依次选择 **“疾病字典”** 和 **“添加”**。

15. 在 **“支持元素”** 下，选择 **“添加支持元素”** 和 **“包含此关键字列表”** 以添加对关键字字典的其他支持。

16. 在 **“关键字列表”** 下方的文本框中，输入以下关键字：*员工,缺勤,原因*

17. 将 **“最小计数”** 值增加到 *2*。

18. 选择 **“下一步”**，查看配置，然后选择 **“完成”**。
...
10. 从左上方选择 **“搜索”**，然后输入 *Contoso*。

11. 选择 **“Contoso 员工 ID”** 以打开右侧窗格。

12. 从右侧窗格中选择 **“测试类型”**。

13. 在 **“上传要测试的文件”** 页面上，选择 **“单击浏览”**。
...
20. 在 **“上传要测试的文件”** 页面上，选择 **“单击浏览”**。

21. 从左侧窗格中选择 **“文档”**，选择 *SickTestData* 文件，然后选择 **“打开”**。

22. 选择 **“测试”** 以开始分析。

23. 在 **“匹配结果”** 页面上，查看找到的匹配项。
