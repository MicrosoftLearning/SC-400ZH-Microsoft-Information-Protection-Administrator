...
6. 在 **“为保留标签命名”** 页上的 **“名称”**、**“针对管理员的说明”** 和 **“针对用户的说明”** 中，输入以下信息：
...
8. 在 **“保留期设置”** 页面上，启用 **“保留特定时间段内的项”设置**。
...
11. 在“查看并完成”页面上，选择 **“创建标签”** 按钮。  依次选择 **“暂时保存标签”**、**“完成”**。

12. 返回到 **“信息治理”** 页面上的 **“标签”** 选项卡。  我们将在下一个练习发布标签。

13. 选择 **“+ 创建标签”按钮**

14. 在“为策略命名”页上的 **“名称”**、**“针对管理员的说明”** 和 **“针对用户的说明”** 中，输入以下信息：
	- **名称**：信用卡收据
...
18. 在 **“查看设置”** 页面上，选择 **“创建标签”按钮**。依次选择 **“暂时保存标签”**、**“完成”**。

你已成功为保留期为 7 年的增值税申报表创建了保留标签，并为信用卡收据创建了保留标签。

### 任务 2 - 发布保留标签

执行任务 1 之后，你将立即发布增值税申报表保留标签，以便财务用户可以将已发布的标签应用于 Exchange 电子邮件和 Sharepoint 文档位置中的文档。
...
11. 在 **“为策略命名”** 页上的 **“名称”** 和 **“说明”** 中输入以下信息：
...
13. 在 **“查看设置”** 页面上，选择 **“提交”** 按钮。  发布策略后，选择 **“完成”**。

你已成功发布增值税申报表和支持性文档的保留标签。

### 任务 3 - 发布自动应用保留标签

执行任务 1 之后，现在将自动应用信用卡收据保留标签，以便 
...
6. 选择 **“自动应用标签”** 按钮。  将显示“将标签自动应用于内容”向导。
...
9. 在 **“标签信息”** 页面上，为“选择要应用此标签的内容类型”选择以下选项：
...
16. 在 **“位置”** 页面上，启用 **“Exchange 电子邮件”、“OneDrive”、“SharePoint 网站”和“Microsoft 365 组”** 选项，然后选择 **“下一步”**。

17. 在 **“标签”** 页面上，选择 **“下一步”**。

18. 在 **“完成”** 页面上，选择 **“提交”** 按钮。
...
6. 由于创建保留策略时会有一些延迟，因此可能无法选择在上一个练习中创建的策略。如果可用，请选择 **“增值税申报表和支持性文档”**，否则请从现有策略中选择 **“1 个月后删除”**。这只是为了在此练习中应用设置，请记住，保留策略可能需要一天或更长的时间才能在租户中可用。
...
7.  如果可用，请将 **“文件夹策略”** 下拉列表设置为 **“增值税申报表和支持性文档”**，否则从现有策略中选择 **“5 年后删除”** （仅适用于本练习中的设置）。
...
4. 在 SharePoint 登陆页面上，向下滚动并选择 **“通信网站”** SharePoint 网站。
...
11. 如果该选项可用，请将 **“应用保留标签”** 设置为 **“增值税申报表和支持性文档”**。由于发布保留标签可能需要一些时间，因此可能无法立即使用该选项，如果该选项不可用，不用担心，请继续执行下一个任务。
...
3. 在 Microsoft O365 登陆页面上，选择左上角带有九个点的“应用启动器”图标，然后从子菜单中选择 **“OneDrive”**。
...
8. 如果该选项可用，请将 **“应用保留标签”** 设置为 **“增值税申报表和支持性文档”**。由于发布保留标签可能需要一些时间，因此可能无法立即使用该选项，如果该选项不可用，不用担心，请继续执行下一个练习。
