...
11. 在“**查看并完成**”页面上，选择“**创建标签**”按钮。  选择“**无操作**”，然后选择“**完成**”。
...
18. 在“**查看并完成**”页面上，选择“**创建标签**”按钮。选择“**无操作**”，然后选择“**完成**”。
...
13. 在 **“查看设置”** 页面上，选择 **“提交”** 按钮。  创建策略后，选择 **“完成”**。
...
16. 在 **“选择应用策略的位置”** 页面上，启用以下选项：**“Exchange 电子邮件”、“OneDrive 帐户”、“SharePoint 网站”和“Microsoft 365 组”**，然后选择 **“下一步”**。

17. 在 **“选择要自动应用的标签”** 页面上，选择 **“下一步”**。

18. 在 **“选择要自动应用的标签”** 页面上，选择 **“提交”** 按钮。  创建策略后，选择 **“完成”**。
...
11. 如果该选项可用，请将 **“应用标签”** 设置为 **“增值税申报表和支持性文档”** ，并选择 **“保存”**。由于发布保留标签可能需要一些时间，因此可能无法立即使用该选项，如果该选项不可用，不用担心，请继续执行下一个任务。
