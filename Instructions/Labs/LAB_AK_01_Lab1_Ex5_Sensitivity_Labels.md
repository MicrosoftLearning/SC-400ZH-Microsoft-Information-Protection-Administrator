...
5. 输入表示“是”的 **Y** 并按 Enter，以确认“不受信任的存储库安全”对话框。
...
4. 在“信息保护”页面上，选择 **“+ 创建标签”**。

5. 此时会启动 **“新建敏感度标签”** 向导。在 **“名称和描述”** 页面上的 **“名称”**、**“针对管理员的说明”** 和 **“针对用户的说明”** 中，输入以下信息：
...
16. 在 **“信息保护”** 页面上，突出显示（无需选择）刚创建的内部标签，然后选择 **…**。

17. 从下拉菜单中选择 **“+ 添加子标签”**。

18. 此时会启动 **“新建敏感度标签”** 向导。在 **“名称和描述”** 页面上的 **“名称”**、**“针对管理员的说明”** 和 **“针对用户的说明”** 中，输入以下信息：
...
20. 在 **“范围”** 页面上，选择 **“文件和电子邮件”** 选项。

21. 选择 **“下一步”**。

22. 在 **“文件和电子邮件”** 页面上，选择 **“加密文件和电子邮件”** 选项
...
30. 在 **“自动标记”** 页面上，选择 **“下一步”**。

31. 在 **“组和网站”** 页面上，选择 **“下一步”**。

32. 在 **“Azure Purview 资产(预览)”** 页面上，选择 **“下一步”**。 
...
4. 在 **“信息保护”** 页面上，选择 **“发布标签”**。

5. 此时会启动“发布敏感度标签”向导。

6. 在 **“选择要发布的标签”** 页面上，选择 **“选择要发布的敏感度标签”** 链接。
...
10. 在 **“选择要发布的标签”** 页面上，选择 **“下一步”**。

11. 在 **“发布到用户和组”** 页面上，选择 **“下一步”**。

12. 在 **“策略设置”** 页面上，选择 **“下一步”**。

13. 在 **“名称和描述”** 页面上，输入以下信息：
...
6. 此时会启动 **“新建敏感度标签”** 向导。在 **“名称和描述”** 页面上，输入以下信息：
...
8. 在 **“范围”** 页面上，选择 **“文件和电子邮件”** 选项。

8. 选择 **“下一步”**。

9. 在 **“文件和电子邮件”** 页面上，选择 **“下一步”**。

10. 在 **“自动标记”** 页面上，将 **“自动标记文件和电子邮件”** 设置为启用。
...
19. 在 **“组和网站”** 页面上，选择 **“下一步”**。

20. 在 **“Azure Purview 资产(预览)”** 页面上，选择 **“下一步”**。 
...
26. 在 **“选择要发布的标签”** 页面上，选择 **“选择要发布的敏感度标签链接”**。
...
30. 在 **“选择要发布的标签”** 页面上，选择 **“下一步”**。

31. 在 **“发布到用户和组”** 页面上，选择 **“下一步”**。

32. 在 **“策略设置”** 页面上，选择 **“下一步”**。

33. 在 **“名称和描述”** 页面上，输入以下信息：
